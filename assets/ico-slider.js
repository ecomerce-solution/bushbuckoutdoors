...
(function() {
    ...
    ICOSLIDER.curtainAnimating = false;

    ICOSLIDER = {
        init: function() {

            // Set up each slider
            jQuery( '.ico-slider' ).each(
                function( i ) {
                    ...
                    // Setup slider
                    ICOSLIDER.setupSlider( i, sliderID );

                    // Prepare the first slide
                    ICOSLIDER.prepareFirstSlide( i, jQuery( '#' + sliderID ) );
                }
            );

            $window.smartresize(
                function() {
                    ICOSLIDER.resizeSliders();
                }
            );
        ...
        setupSlider: function( i, sliderID ) {
            ...
            if ( sliderType == "curtain" ) {
                icoSliderElements[i] = new Swiper(
                    sliderInstance, {
                        loop: false,
                        progress: true,
                        mode: 'vertical',
                        ...
                        onFirstInit: ICOSLIDER.afterSliderCurtainInit,
                        onSlideChangeStart: ICOSLIDER.slideTransitionStart,
                        onSlideChangeEnd: ICOSLIDER.slideTransitionEnd,
...
//                            }
                ...
                icoSliderElements[i] = new Swiper(
                    sliderInstance, {
                        ...
                        onFirstInit: ICOSLIDER.afterSliderInit,
                        onSlideChangeStart: ICOSLIDER.slideTransitionStart,
                        onSlideChangeEnd: ICOSLIDER.slideTransitionEnd,
                        onProgressChange: function(swiper) {
                            for (var i = 0; i < swiper.slides.length; i++) {
        ...
        prepareFirstSlide: function( i, sliderInstance ) {
            ...
            sliderInstance.find( '.ico-slider-pagination, .ico-slider-prev, .ico-slider-next, .ico-slider-continue' ).removeClass( 'dark' ).removeClass( 'light' ).addClass( sliderInstance.find( '.swiper-slide-active' ).data( 'style' ) );
                ...
                if ( !jQuery( 'html' ).hasClass( 'no-video' ) && !isMobileAlt ) {
                    ...
                    videoInstance.addEventListener(
                        'loadeddata', function() {
                            ...
                            ICOSLIDER.sliderLoaded( i, sliderInstance );
                            ICOSLIDER.setSliderContent( sliderInstance );
                            ICOSLIDER.showControls( sliderInstance );
                            ICOSLIDER.slideTransitionEnd( icoSliderElements[i], delay );
        ...
        afterSliderCurtainInit: function( e ) {
            ...
            var sliderObject = e,
                ...
                scrollIndicator = sliderInstance.find( '.ico-scroll-indicator' );
            ...
            setTimeout(
                function() {
                    ICOSLIDER.scrollIndicatorAnimate( scrollIndicator );
                }, 1000
            );

            // Bind scroll event on load
            if ( $window.scrollTop() < 10 ) {
                ICOSLIDER.curtainEnter( sliderObject, sliderInstance );
            } else {
        ...
        sliderLoaded: function( i, sliderInstance ) {
            ...
            // Fade out the loader
            sliderInstance.find( '#ico-slider-loader' ).fadeOut( 400 );
            ...
            if ( (sliderInstance.parent().parent( 'body' ).length > 0 
                  || sliderInstance.offset().top === 0) && !isMobileAlt) {
                sliderInstance.addClass('ico-slider-parallax');
                parallaxInstance = sliderInstance;
                ICOSLIDER.parallax( );
            }

            // Slider prev button
            sliderInstance.find( '.ico-slider-prev' ).on(
                'click', function( e ) {
                    e.preventDefault();
                    if ( body.css( "direction" ).toLowerCase() == "rtl" ) {
                        icoSliderElements[i].swipeNext();
                    } else {
                        icoSliderElements[i].swipePrev();
                    }
                }
            );

            // Slider next button
            sliderInstance.find( '.ico-slider-next' ).on(
                'click', function( e ) {
                    e.preventDefault();
                    if ( body.css( "direction" ).toLowerCase() == "rtl" ) {
                        icoSliderElements[i].swipePrev();
            ...
            // Slieder pagination
            sliderInstance.find( '.ico-slider-pagination' ).on(
                'click', '> div', function( e ) {
                    icoSliderElements[i].swipeTo( jQuery( this ).index() );
                    sliderInstance.find( '.ico-slider-pagination .dot' ).removeClass( 'active' );
                    jQuery( this ).addClass( 'active' );
                }
            );

            // Curtain slider continue
            sliderInstance.find( '.ico-slider-continue' ).on(
                'click', function( e ) {
                    e.preventDefault();
                    ICOSLIDER.curtainAdvance( sliderInstance );
                }
            );
        ...
        curtainAdvance: function( sliderInstance ) {
            ...
            body.css( 'overflow', '' );
            ICOSLIDER.curtainAnimating = true;
        },
        showControls: function( sliderInstance ) {
            ...
            if ( sliderInstance.data( 'type' ) != "curtain" ) {
                if ( sliderInstance.data( 'loop' ) ) {
                    sliderInstance.find( '.ico-slider-prev' ).fadeIn( 400 );
                }
                sliderInstance.find( '.ico-slider-next' ).fadeIn( 400 );
                sliderInstance.find( '.ico-slider-pagination .dot' ).first().addClass( 'active' );
                sliderInstance.find( '.ico-slider-pagination' ).fadeIn( 600 );
                sliderInstance.find( '.ico-slider-continue' ).removeClass( 'continue-hidden' );
            } else if ( sliderInstance.data( 'type' ) === "curtain" ) {
                sliderInstance.find( '.ico-slider-pagination .dot' ).first().addClass( 'active' );
                sliderInstance.find( '.ico-slider-pagination' ).css(
                    'margin-top', -sliderInstance.find( '.ico-slider-pagination' ).height() / 2
                );
                sliderInstance.find( '.ico-slider-pagination' ).fadeIn( 600 );
        ...
        parallax: function() {
            ...
            if ( parallaxCanScroll ) {
                window.addEventListener('scroll', function(){ 
                    requestAnimationFrame(ICOSLIDER.parallaxScroll) 
                }, false)
            }
        },
        parallaxScroll: function(sliderHeight) {
            ...
            if ( $window.width() > 768 ) {
                ...
                // Fade the pagination
                parallaxInstance.find( '.ico-slider-pagination' ).stop( true, true ).transition(
                    {
                        opacity: 1 - scrollTop / ( parallaxSliderHeight - 150 )
                    }, 0
                );
        ...
        resizeSliders: function( sliderInstance ) {
            ...
            if ( sliderInstance ) {
                ...
                ICOSLIDER.setSliderSize( ssInstance, ssFullscreen, sliderWidth, sliderHeight );

                // Check if a video is present
                if ( ssVideoWrap.length > 0 ) {
                    ICOSLIDER.setSlideVideoSize( ssVideoWrap, sliderWidth, sliderHeight );
                }
        ...
        setSliderSize: function( ssInstance, ssFullscreen, sliderWidth, sliderHeight ) {
            ...
            ssInstance.css( 'height', sliderHeight );
            ssInstance.parents('.ico-slider-outer').css( 'height', sliderHeight );
            ...
            if ( contentHeight > sliderHeight ) {
                ...
                ssInstance.parents('.ico-slider-outer').css( 'height', contentHeight + 60 );
        ...
        slideTransitionStart: function( e ) {
            ...
            if ( jQuery.isNumeric(currentSlideIndex) ) {
                sliderInstance.find( '.ico-slider-pagination .dot:nth-child(' + currentSlideIndex + ')' ).addClass( 'active' );
            }

            // Set curtain controls
            if ( currentSlideID > 1 ) {
                sliderInstance.find( '.ico-scroll-indicator' ).fadeOut( 300 );
            } else {
                sliderInstance.find( '.ico-scroll-indicator' ).fadeIn( 300 );
            }
            ...
            if ( currentSlideID === numberOfSlides && ssContinue ) {
                ...
                setTimeout(
                    function() {
                        sliderInstance.find( '.ico-slider-continue' ).addClass( 'continue-hidden' );
                    }, 300
                );
            }

            // Set controls style based on the slide
            sliderInstance.find( '.ico-slider-pagination, .ico-slider-prev, .ico-slider-next, .ico-slider-continue' ).removeClass( 'dark' ).removeClass( 'light' ).addClass( currentSlide.data( 'style' ) );

            if ( currentSlideIndex === 1 && !sliderInstance.data( 'loop' ) ) {
                sliderInstance.find( '.ico-slider-prev' ).css( 'display', 'none' );
                sliderInstance.find( '.ico-slider-next' ).css( 'display', 'block' );
            } else if ( currentSlideIndex === sliderInstance.find( '.swiper-slide' ).length && !sliderInstance.data( 'loop' ) ) {
                sliderInstance.find( '.ico-slider-prev' ).css( 'display', 'block' );
                sliderInstance.find( '.ico-slider-next' ).css( 'display', 'none' );
            } else {
                sliderInstance.find( '.ico-slider-prev' ).css( 'display', 'block' );
                sliderInstance.find( '.ico-slider-next' ).css( 'display', 'block' );
            }
        ...
        slideTransitionEnd: function( e, delay ) {
            var sliderObject = e,
                ...
                pagination = sliderInstance.find( '.ico-slider-pagination' ),
                numberOfSlides = pagination.find( '.dot' ).length,
                sliderPrev = jQuery( '.ico-slider-prev' ).find( 'h4' ),
                sliderNext = jQuery( '.ico-slider-next' ).find( 'h4' ),
...
var Swiper = function (selector, params) {
    ...
    _this.swipePrev = function (runCallbacks, internal) {
        ...
        var ai = jQuery( _this.container );
        if ( ai.data( "type" ) === "curtain" && ICOSLIDER.curtainAnimating ) {
            return false;
        }
